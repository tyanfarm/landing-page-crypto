 ...
 */
const fs = require('fs');
const commonCliConfig = 'node_modules/@angular-devkit/build-angular/src/tools/webpack/configs/common.js';
const pugRules = '{test:/\\.(pug|jade)$/,exclude:/\\.(include|partial)\\.(pug|jade)$/,use:[{loader:"apply-loader"},{loader:"pug-loader"}]},{test:/\\.yml$/,loader:"yml-loader"},';;
...
fs.readFile(commonCliConfig, (err, data) => {
  ...
  */
 const typescriptCliConfig = 'node_modules/@angular-devkit/build-angular/src/tools/webpack/plugins/typescript.js';;
